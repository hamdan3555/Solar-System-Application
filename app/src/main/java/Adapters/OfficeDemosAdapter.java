...
public class OfficeDemosAdapter extends RecyclerView.Adapter<OfficeDemosAdapter.ViewHolder> {
    Context context;
    ArrayList<String> imageURLs;

    public OfficeDemosAdapter(Context context, ArrayList<String> imageURLs) {
        this.context = context;
        this.imageURLs = imageURLs;
    }

    public void add_office(String url){
        imageURLs.add(url);
    ...
    @Override
    public OfficeDemosAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.home_demos_item,parent,false);
        return new ViewHolder(view);
            }

    @Override
    public void onBindViewHolder( OfficeDemosAdapter.ViewHolder holder, int position) {
