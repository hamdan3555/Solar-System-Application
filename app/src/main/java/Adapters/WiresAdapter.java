...
public class WiresAdapter extends RecyclerView.Adapter<WiresAdapter.ViewHolder> {
    Context context;
    ArrayList<String> imageURLs;

    public WiresAdapter(Context context, ArrayList<String> imageURLs) {
    ...
    @Override
    public WiresAdapter.ViewHolder onCreateViewHolder( ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.product_demos_item,parent,false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder( WiresAdapter.ViewHolder holder, int position) {
