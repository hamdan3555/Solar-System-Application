...
public class BateryAdapter extends RecyclerView.Adapter<BateryAdapter.ViewHolder> {
    Context context;
    ArrayList<String> imageURLs;

    public BateryAdapter(Context context, ArrayList<String> imageURLs) {
    ...
    @Override
    public BateryAdapter.ViewHolder onCreateViewHolder( ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.product_demos_item,parent,false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(BateryAdapter.ViewHolder holder, int position) {
