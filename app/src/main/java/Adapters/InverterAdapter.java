...
public class InverterAdapter extends RecyclerView.Adapter<InverterAdapter.ViewHolder> {
    Context context;
    ArrayList<String> imageURLs;

    public InverterAdapter(Context context, ArrayList<String> imageURLs) {
    ...
    @Override
    public void onBindViewHolder( InverterAdapter.ViewHolder holder, int position) {
