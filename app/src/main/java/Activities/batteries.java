...
public class batteries extends AppCompatActivity {
    ...
    public void set_up_recycle_view(){
        ...
        adapter = new BateryAdapter(this, imageURLs1);
        GridLayoutManager gridLayoutManager = new GridLayoutManager(this, 2);
        recycle_view = findViewById(R.id.recycle_view_batery);
    ...
    private void setupStorage() {
        StorageReference listRef = storage.getReference().child("batteries");
        listRef.listAll()
