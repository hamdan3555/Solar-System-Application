...
import Adapters.HomeDemosAdapter;
import Adapters.OfficeDemosAdapter;

public class OfficesProjectDemos extends AppCompatActivity {
    FirebaseStorage storage;
    ArrayList<StorageReference> imageURLs = new ArrayList<StorageReference>();
    OfficeDemosAdapter adapter;
    RecyclerView recycle_view;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_offices_project_demos);
    ...
    public void set_up_recycle_view(){
        ...
        adapter = new OfficeDemosAdapter(this, imageURLs1);
        GridLayoutManager gridLayoutManager = new GridLayoutManager(this, 2);
        recycle_view = findViewById(R.id.recycle_view_office);
        ...
        for (StorageReference sr:
            ...
            sr.getDownloadUrl().addOnSuccessListener(uri -> {
                ...
                adapter.add_office(uri.toString());
            });
        }
    ...
    private void setupStorage() {
        StorageReference listRef = storage.getReference().child("offices");
        listRef.listAll()
