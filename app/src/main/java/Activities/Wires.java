...
import Adapters.WiresAdapter;

public class Wires extends AppCompatActivity {
    ...
    public void set_up_recycle_view(){
        ...
        adapter = new WiresAdapter(this, imageURLs1);
        GridLayoutManager gridLayoutManager = new GridLayoutManager(this, 2);
        recycle_view = findViewById(R.id.recycle_view_wires);
    ...
    private void setupStorage() {
        StorageReference listRef = storage.getReference().child("wires");
        listRef.listAll()
