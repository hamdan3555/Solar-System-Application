...
import Adapters.InverterAdapter;
import Adapters.PanelAdapter;

public class Inverters extends AppCompatActivity {
    FirebaseStorage storage;
    ArrayList<StorageReference> imageURLs = new ArrayList<StorageReference>();
    InverterAdapter adapter;
    ...
    public void set_up_recycle_view(){
        ...
        adapter = new InverterAdapter(this, imageURLs1);
        GridLayoutManager gridLayoutManager = new GridLayoutManager(this, 2);
        recycle_view = findViewById(R.id.recycle_view_inverters);
    ...
    private void setupStorage() {
        StorageReference listRef = storage.getReference().child("inverters");
        listRef.listAll()
